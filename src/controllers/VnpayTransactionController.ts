...
class VnpayTransactionController extends BaseController {
  ...
  CreatePaymentUrl = async (req, res) =>
    this.ProcessAsync(req, res, () => this._business.CreatePaymentUrl(req));

  Return = async (req, res) =>
    this.ProcessAsync(req, res, () => this._business.Return(req));

  IPN = async (req, res) =>
    this.ProcessAsync(req, res, () => this._business.IPN(req));
}
