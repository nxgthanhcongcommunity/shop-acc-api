...
import { AccountModel, BalanceModel, InvoiceDetailModel, InvoiceModel, ProductModel, QuantityModel, SendMailModel } from "../models";
...
interface ICreateInvoiceReq extends Optional<IInvoiceCreationAttributes, NullishPropertiesOf<IInvoiceCreationAttributes>> { }
...
class InvoiceRepository {
    ...
    BulkCreateInvoiceDetails = async (req: IInvoiceDetailCreationAttributes[]) => {
