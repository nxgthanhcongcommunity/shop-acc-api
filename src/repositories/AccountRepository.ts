...
class AccountRepository {
    ...
    GetNotificationsByAccountCode = async (req: IGetNotificationsByAccountCodeReq) => {
        const { accountCode } = req;
    ...
    CreateAccount = async (req: Optional<IAccountCreationAttributes, NullishPropertiesOf<IAccountCreationAttributes>>) => {
